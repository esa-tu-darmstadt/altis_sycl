...
float schlick(float cosine, float ref_idx) {
    ...
    r0 = r0*r0;
    return r0 + (1.0f - r0) * sycl::pow<double>((1.0f - cosine), 5.0f);
}
...
/*
DPCT1032:491: A different random number generator is used. You may need to
adjust the code.
*/
...
class material  {
    public:
        ...
        /*
        DPCT1109:61: Virtual functions cannot be called in SYCL device code. You
        need to adjust the code.
        */
        /*
        DPCT1032:492: A different random number generator is used. You may need
        to adjust the code.
        */
...
class lambertian : public material {
    public:
        ...
        /*
        DPCT1109:62: Virtual functions cannot be called in SYCL device code. You
        need to adjust the code.
        */
        /*
        DPCT1032:493: A different random number generator is used. You may need
        to adjust the code.
        */
        virtual bool scatter(
            const ray &r_in, const hit_record &rec, vec3 &attenuation,
...
class metal : public material {
    public:
        ...
        /*
        DPCT1109:63: Virtual functions cannot be called in SYCL device code. You
        need to adjust the code.
        */
        /*
        DPCT1032:494: A different random number generator is used. You may need
        to adjust the code.
        */
        virtual bool scatter(
            const ray &r_in, const hit_record &rec, vec3 &attenuation,
...
public:
    ...
    /*
    DPCT1109:64: Virtual functions cannot be called in SYCL device code. You
    need to adjust the code.
    */
    virtual bool
    scatter(const ray &r_in, const hit_record &rec, vec3 &attenuation,
            ray &scattered,
            /*
            DPCT1032:495: A different random number generator is used. You may
            need to adjust the code.
            */
            dpct::rng::device::rng_generator<oneapi::mkl::rng::device::mcg59<1>>
                *local_rand_state) const {
