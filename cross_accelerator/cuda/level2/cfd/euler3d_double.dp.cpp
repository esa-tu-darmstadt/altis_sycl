...
void
dump(double *variables, int nel, int nelr, sycl::queue &queue)
{
...
void
initialize_variables(int nelr, double *variables, sycl::queue &queue)
{
...
compute_flux_contribution(double        &density,
...
SYCL_EXTERNAL inline void
compute_velocity(double        &density,
                 sycl::double3 &momentum,
                 sycl::double3 &velocity)
{
...
compute_speed_sqd(sycl::double3 &velocity)
{
...
SYCL_EXTERNAL inline double
compute_speed_of_sound(double &density, double &pressure)
{
...
cuda_compute_flux(int              nelr,
                  ...
                  double          *fluxes,
                  sycl::nd_item<3> item_ct1,
                  double           ff_variable_idx1,
                  double           ff_variable_idx2,
                  double           ff_variable_idx3,
             ...
             sycl::queue &queue)
{
    ...
    sycl::event    k_event = queue.submit([&](sycl::handler &cgh) {
        ...
        sycl::double3 ff_flux_contribution_momentum_x = h_ff_flux_contribution_momentum_x;
        sycl::double3 ff_flux_contribution_momentum_y = h_ff_flux_contribution_momentum_y;
        sycl::double3 ff_flux_contribution_momentum_z = h_ff_flux_contribution_momentum_z;
        sycl::double3 ff_flux_contribution_density_energy = h_ff_flux_contribution_density_energy;
...
cfd(ResultDatabase &resultDB, OptionParser &op, size_t device_idx)
{
    ...
    resultDB.AddResult(
        "cfd_double_parity", atts, "N", transferTime / kernelTime);
