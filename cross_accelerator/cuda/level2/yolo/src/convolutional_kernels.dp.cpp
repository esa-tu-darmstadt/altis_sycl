...
void binarize_gpu(float *x, int n, float *binary)
{
    ...
    /*
    DPCT1010:1084: SYCL uses exceptions to report errors and does not use the
...
void binarize_input_gpu(float *input, int n, int size, float *binary)
{
    ...
    /*
    DPCT1010:1085: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
void binarize_weights_gpu(float *weights, int n, int size, float *binary)
{
    ...
    /*
    DPCT1010:1086: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void smooth_layer(layer l, int size, float rate)
{
    ...
    /*
    DPCT1010:1087: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
